...
public class Sbb implements Instruction {
    ...
    public int exec(String eip, int opcode) {
        ...
        int re=Integer.parseInt(new Transformer().binaryToInt(String.valueOf(CPU_State.eax.read())))-immediate-1;
        CPU_State.eax.write(new Transformer().intToBinary(Integer.parseInt(new Transformer().binaryToInt(String.valueOf(CPU_State.eax.read())))-immediate-1+""));
