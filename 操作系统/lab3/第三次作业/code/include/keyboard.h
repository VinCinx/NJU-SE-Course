...
#define FLAG_BREAK	0x0080		/* Break Code			         1000 0000*/
#define FLAG_EXT	0x0100		/* Normal function keys        1 0000 0000*/
#define FLAG_SHIFT_L	0x0200		/* Shift key	          10 0000 0000*/
#define FLAG_SHIFT_R	0x0400		/* Shift key		     100 0000 0000*/
#define FLAG_CTRL_L	0x0800		/* Control key			    1000 0000 0000*/
#define FLAG_CTRL_R	0x1000		/* Control key			  1 0000 0000 0000*/
#define FLAG_CTRL   0x1800/*新添加，做与操作，看有没有按下ctrl键*/
#define FLAG_ALT_L	0x2000		/* Alternate key		 10 0000 0000 0000*/
#define FLAG_ALT_R	0x4000		/* Alternate key		100 0000       ...*/
#define FLAG_PAD	0x8000		/* keys in num pad	   1000 0000   ...    */
